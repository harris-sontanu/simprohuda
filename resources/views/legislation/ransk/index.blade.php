                ...
                <div class="card-body p-0 border-top">
                    <ul class="nav nav-tabs nav-tabs-bottom mb-0 border-bottom-0">
                        @foreach ($tabFilters as $key => $value)
                            ...
                            <li class="nav-item">
                                <a href="{{ route('legislation.ransk.index', ['tab' => $key] + Request::all()) }}" class="nav-link{{ $active }}">
                    ...
                    <thead>
                        <tr class="bg-light">
                            ...
                            <th class="@php echo (!empty($sort) AND Request::get('order') == 'reg_number') ? 'sorting_' . $sort : 'sorting'; @endphp">
                                <a href="{{ route('legislation.ransk.index', ['order' => 'reg_number', 'sort' => $sortState] + Request::all()) }}" class="text-body d-block"><abbr title="Nomor Urut Registrasi" data-popup="tooltip">Nomor</abbr></a>
                            </th>
                            ...
                            <tr>
                                ...
                                <td class="text-center safezone">
                                    <div class="list-icons">
                                        <a href="{{ route('legislation.ransk.show', $legislation->id) }}" class="list-icons-item" data-popup="tooltip" title="Pratinjau" data-id="{{ $legislation->id }}"><i class="icon-eye"></i></a>
                                        @if ($onlyTrashed)
                                        ...
                                        @else
                                            @if ($legislation->status() !== 'validated')                                                
                                                <a href="{{ route('legislation.ransk.edit', $legislation->id) }}" data-popup="tooltip" title="Perbaiki" class="list-icons-item"><i class="icon-pencil"></i></a>
