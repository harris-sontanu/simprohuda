                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-8 offset-lg-2">
                                ...
                                <!-- Form -->
                                <form id="update-form" method="POST" action="{{ route('legislation.ransk.update', $legislation->id) }}" novalidate>
                                    @method('PUT')
                                    @csrf
                                </form>
                                        ...
                                        <div class="form-group row mb-0">
                                            <div class="col-lg-9 offset-lg-3">
                                                ...
                                                @else
                                                    ...
                                                    @if ($validateButton)  
                                                        @cannot('isOpd')                                                            
                                                            <form id="validation-form" action="{{ route('legislation.ransk.approve', $legislation->id) }}" method="post" class="d-inline-block" data-title="{{ $legislation->title }}">
                                                                @csrf
                                                                @method('PUT')
