                ...
                <div class="card-body p-0 border-top">
                    <ul class="nav nav-tabs nav-tabs-bottom mb-0 border-bottom-0">
                        @foreach ($tabFilters as $key => $value)
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.user.index', ['tab' => $key] + Request::all()) }}" class="nav-link{{ $active }}">
                                ...
                                <td class="safezone">
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            @else
                                                <a href="{{ route('admin.user.edit', $user->id) }}" class="dropdown-item"><i class="icon-pencil"></i> Ubah</a>
