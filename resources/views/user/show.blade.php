<div class="card m-0">
    ...
    <div class="card-body text-center bg-indigo card-img-top text-white @if (Route::currentRouteName() == 'user.show') rounded-0 @endif" style="background-image: url(/assets/images/backgrounds/panel_bg.png); background-size: contain;">
    ...
    <div class="card-body border-top-0">
        ...
        @if ($user->getRawOriginal('role') === 'opd')        
            <div class="d-sm-flex flex-sm-wrap mb-3">
                ...
                @empty ($user->institutes->first()->name)
                    <div class="ms-sm-auto mt-2 mt-sm-0">-</div>
                @else
                    <div class="ms-sm-auto mt-2 mt-sm-0">{{ $user->institutes->first()->name }}</div>
                @endempty
            </div>        
        @endif
        ...
        <div class="d-sm-flex flex-sm-wrap mb-3">
            ...
            <div class="ms-sm-auto mt-2 mt-sm-0">{!! $user->statusBadgeHtml !!}</div>
        </div>
